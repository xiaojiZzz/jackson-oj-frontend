...
export class UserControllerService {
    ...
    public static listUserVoByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/user/list/page/vo',
            body: userQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
