...
export class QuestionControllerService {
    ...
    public static listQuestionByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/list/page',
    ...
    public static listQuestionVoByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/list/page/vo',
            body: questionQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
    ...
    public static listMyQuestionVoByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/my/list/page/vo',
            body: questionQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
    ...
    public static doQuestionSubmitUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/question_submit/do',
    ...
    public static listQuestionSubmitByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/question_submit/list/page',
    ...
    public static listMyQuestionSubmitByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/jacksonoj/question/question_submit/my/list/page',
            body: questionSubmitQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
